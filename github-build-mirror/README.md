...
Build artifacts for FrogTalk **v1.6.50-alpha** (Android `versionCode` **256**).
...
### Android (v1.6.50-alpha / 256)

| Artifact | File | Use |
|----------|------|-----|
| **APK (sideload)** | [frogtalk-v256-alpha.apk](./frogtalk-v256-alpha.apk) · [download](https://frogtalk.app/download/android) | Direct install |
| **AAB (Play Store)** | [FrogTalk-1.6.50-alpha-256.aab](./FrogTalk-1.6.50-alpha-256.aab) | Google Play Console upload |
