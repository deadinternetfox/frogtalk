...
<head>
    ...
    <style>
        /* Themed scrollbars — applied globally, with read-mode overrides
           defined further below in the read-theme block. */
        html:not([data-theme="read"]) { scrollbar-width: thin; scrollbar-color: #2a5a35 #0a1610; }
        html:not([data-theme="read"]) ::-webkit-scrollbar { width: 10px; height: 10px; }
        html:not([data-theme="read"]) ::-webkit-scrollbar-track { background: #0a1610; }
