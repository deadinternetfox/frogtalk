...
DEFAULT_FILES=(
  ...
  "node/static/frogtalk-v241.apk:node/static/frogtalk-v241.apk"
  "node/static/github-build-mirror/frogtalk-v241.apk:node/static/github-build-mirror/frogtalk-v241.apk"
  "node/static/github-build-mirror/FrogTalk-1.6.36-241.aab:node/static/github-build-mirror/FrogTalk-1.6.36-241.aab"
  ...
  "node/routers/auth.py:node/routers/auth.py"
  "node/routers/federation.py:node/routers/federation.py"
  "node/routers/directory.py:node/routers/directory.py"
  "node/routers/rooms.py:node/routers/rooms.py"
  "node/routers/messages.py:node/routers/messages.py"
  "node/routers/dms.py:node/routers/dms.py"
  "node/routers/social.py:node/routers/social.py"
  "node/routers/calls.py:node/routers/calls.py"
  "node/routers/ws.py:node/routers/ws.py"
