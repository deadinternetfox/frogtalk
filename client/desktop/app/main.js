...
<p style="color:#8b949e;margin-top:0;line-height:1.45">Most people use the official FrogTalk node at <strong style="color:#e6edf3">frogtalk.app</strong> — it is pre-filled below. Edit or replace it to use your own self-hosted server or any trusted community node.</p>
<input id="url" value="${OFFICIAL_SERVER_INPUT}" style="width:100%;box-sizing:border-box;padding:10px;border-radius:8px;border:1px solid #30363d;background:#161b22;color:#e6edf3" placeholder="frogtalk.app">
