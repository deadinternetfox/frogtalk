...
| E — Voice/video integrity | 2: wire calls.js to sign on offer/answer + verify on receive + Safety Numbers UI | ⏳ in progress (calls.js wired; safety numbers UI pending) | `fb3175a` |
